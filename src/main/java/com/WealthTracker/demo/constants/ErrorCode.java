...
public enum ErrorCode {
    ...
    INVALID_PAYMENT_DETAIL1(400, "결제 상세 정보가 비어 있습니다."),
    INVALID_PAYMENT_DETAIL2(400, "결제 상세 정보를 변환할 수 없습니다."),
    INVALID_PAYMENT_DETAIL3(400, "결제 예정일 또는 마지막 결제일이 비어 있습니다."),
    INVALID_PAYMENT_DETAIL4(400, "결제 날짜 형식이 유효하지 않습니다."),
    INVALID_PAYMENT_DETAIL5(400, "결제 데이터를 저장할 수 없습니다."),
